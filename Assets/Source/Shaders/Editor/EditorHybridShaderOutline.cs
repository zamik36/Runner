...
public class OldCustomEditorOutline : ShaderGUI
{
    ...
    public override void OnGUI(MaterialEditor editor, MaterialProperty[] prop)
    {
        ...
        //----------OUTLINE-----------//
        MaterialProperty _OutlineWidth = ShaderGUI.FindProperty("_OutlineWidth", prop);

        MaterialProperty _OutlineColor = ShaderGUI.FindProperty("_OutlineColor", prop);
        ...
        editor.ShaderProperty(_OutlineWidth, _OutlineWidth.displayName);
        editor.ShaderProperty(_OutlineColor, _OutlineColor.displayName);
