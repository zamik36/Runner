...
namespace Kuhpik.Tools
{
    ...
    public class DatasDrawer : MonoBehaviour
    {
        ...
        private void Start()
        {
            var playerDataType = typeof(SaveData);
            ...
            playerDataDrawerComponent.SetData(Bootstrap.Instance.itemsToInject.First(x => x.GetType() == playerDataType) as SaveData);
    ...
    public class PlayerDataDrawer : DataDrawer<SaveData> { }
}
